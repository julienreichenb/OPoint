...
class UserMenu extends BaseMenu
{
    ...
    public function init()
    {
        ...
        /**
         * Bachelor : add Tab for user Validation
         */
        $this->addItem([
            'label' => 'Validations',
            'url' => Url::to(['/admin/validation']),
            'sortOrder' => 250,
            'isActive' => (Yii::$app->controller->module && Yii::$app->controller->module->id == 'admin' && Yii::$app->controller->id == 'validation'),
            'isVisible' => Yii::$app->user->can(
                new ManageGroups()
            )
        ]);
