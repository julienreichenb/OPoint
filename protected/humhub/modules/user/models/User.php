...
class User extends ContentContainerActiveRecord implements IdentityInterface, Searchable
{
    ...
    /**
     * Bachelor
     * Returns all Validations relations of this user as ActiveQuery
     * @return \yii\db\ActiveQuery
     */
    public function getValidation()
    {
        return $validations = $this->hasOne(Validation::class, ['idUser' => 'id'])->andOnCondition(['reviewed' => 0]);
    }

    /**
     * Bachelor
     * Return the corresponding company for a user
     * @return \yii\db\ActiveQuery
     */
    public function getCompany()
    {
        return $company = $this->hasOne(Company::class, ['idUser' => 'id']);
    }
