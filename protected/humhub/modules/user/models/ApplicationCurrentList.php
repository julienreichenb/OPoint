 ...
 *
 * Bachlor : model to display the Application sent in list
 */
class ApplicationCurrentList extends Application
{
    /**
    ...
    public function search($params)
    {
        ...
        $query->where(['application.idUser' => Yii::$app->user->id]);
        ...
        $this->load($params);
        $query->joinWith(['user', 'job', 'company']);
