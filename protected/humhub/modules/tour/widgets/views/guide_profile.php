...
<script type="text/javascript">
    ...
    $(document).one('humhub:ready', function () {
        ...
        element: ".edit-account",
            ...
            /*
            ** Bachelor : add validation button
            */
            {
                element: ".valid-account",
                title: <?php echo '<strong>Validate</strong> account'; ?>,
                content: <?php echo 'Click on this button to submit a validation form to the administrator.'; ?>,
                placement: "left"
            },
        {
